r"""
sonic-sounds site smoke test
Tests both intake.html and dashboard.html at desktop viewport (1440x900)
Captures screenshots to sonic-sounds-smoke-*.png
"""
...
with sync_playwright() as p:
    ...
    # Check title
    title = page.title()
    check("title rendered", "sonic-sounds" in title, title)
    ...
    # Capture screenshot
    shot = os.path.join(SHOTS_DIR, "sonic-sounds-smoke-intake-filled.png")
    ...
    with page.expect_download(timeout=10000) as dl_info:
        btn.click()
    dl = dl_info.value
    save_path = os.path.join(SHOTS_DIR, "sonic-sounds-smoke-download.json")
    ...
    # Capture screenshot
    shot = os.path.join(SHOTS_DIR, "sonic-sounds-smoke-dashboard.png")
    page.screenshot(path=shot, full_page=True)
    print(f"  Screenshot: {shot}")
    ...
    shot = os.path.join(SHOTS_DIR, "sonic-sounds-smoke-dashboard-mobile.png")
    ...
    shot = os.path.join(SHOTS_DIR, "sonic-sounds-smoke-intake-mobile.png")
