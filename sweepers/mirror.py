...
is ~/OneDrive/Hermes/Agents/planning/sonic-sounds/.
...
_log = logging.getLogger("sonic_sounds.sweepers.mirror")
...
def run_sweep(*,
    ...
    Args:
      ...
      mirror_dir: defaults to ~/OneDrive/Hermes/Agents/planning/sonic-sounds/
        per R7.
    ...
    if mirror_dir is None:
        mirror_dir = Path.home() / "OneDrive" / "Hermes" / "Agents" / "planning" / "sonic-sounds"
