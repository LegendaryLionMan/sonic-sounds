"""tools/ui_smoke.py — Playwright UI smoke for the sonic-sounds preview.
...
DRIVER_PROFILE = Path(os.path.expandvars(r"%LOCALAPPDATA%/Temp/sonic-sounds-driver"))
...
DEFAULT_OUT_DIR = Path(r"C:/Users/lion_/AppData/Local/Temp/sonic-sounds-smoke")
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Playwright UI smoke for sonic-sounds")
