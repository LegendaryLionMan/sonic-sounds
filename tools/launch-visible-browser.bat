...
set PROFILE_DIR=C:\Users\lion_\AppData\Local\hermes\profiles\chrome-sonic-sounds
set CDP_PORT=9333
set START_URL=http://127.0.0.1:8765/site/library.html
set LOG_DIR=%LOCALAPPDATA%\hermes\logs
set LOG_FILE=%LOG_DIR%\chrome-sonic-sounds.log
...
taskkill /F /FI "WINDOWTITLE eq sonic-sounds-verify*" 2>nul >nul
taskkill /F /FI "IMAGENAME eq chrome.exe" /FI "WINDOWTITLE eq sonic-sounds*" 2>nul >nul
