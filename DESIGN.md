# DESIGN.md — sonic-sounds

> The visual identity for the sonic-sounds project: an HTML front door for the music-album-planning-questionnaire and the full-album-release-package skills.
>
...
│ sonic-sounds · /mixtape '85 · ⌘K         [SIDE A · C-90]│
├─────────────────────────────────────────────────────┤
│                                                     │
│  hero (96px padding)                                │
│  ┌──────────┐ ┌─────────────────────────────────┐   │
...
```
sonic-sounds / mixtape '85 · design system    [▷ SIDE A · C-90]    [▷ PRESS PLAY] [⌘K]
```
