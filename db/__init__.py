"""db/__init__.py — package entry point for sonic-sounds db.

Per plan §7 Day 2 verification:
"python -c \"from tools.sonic_sounds.db import open_db; open_db()\" → opens, runs migrations, PRAGMAs verified"

Note: the plan's path `tools.sonic_sounds.db` was structural at v3.2 time.
...
expects `tools.sonic_sounds.db` as the import path.
