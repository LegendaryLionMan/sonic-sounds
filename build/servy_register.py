...
DISPLAY_NAME = "sonic-sounds daemon (Day 3)"
DESCRIPTION = "sonic-sounds HTTP daemon — Quart ASGI server with WAL+PRAGMAs SQLite."
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Register/unregister sonic-sounds daemon as a Windows Service"
    )
