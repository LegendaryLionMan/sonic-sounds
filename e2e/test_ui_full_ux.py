"""e2e/test_ui_full_ux.py — End-to-end UX verification for sonic-sounds.

This is the canonical E2E spec for the sonic-sounds UI. It exercises
...
BASE = os.environ.get("SONIC_SOUNDS_E2E_BASE", "http://127.0.0.1:8791")
